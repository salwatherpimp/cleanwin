    ...
    <section
      style={{
        ...
        backgroundImage: typeof window !== 'undefined' && window.innerWidth <= 768
          ? 'url(https://res.cloudinary.com/dwlk9of7h/image/upload/w_480,q_70/v1752095181/dobiinter_A_close-up_of_a_cleaning_bucket_filled_with_turqois_c8b4fac7-6123-4eb8-a980-923d98629a76_2_ijdnha.avif)'
          : 'url(https://res.cloudinary.com/dwlk9of7h/image/upload/w_1280,q_70/v1752095181/dobiinter_A_close-up_of_a_cleaning_bucket_filled_with_turqois_c8b4fac7-6123-4eb8-a980-923d98629a76_2_ijdnha.avif)'
      }}
      role="img"
    ...
    >
      ...
      <div style={{
        ...
        padding: typeof window !== 'undefined' && window.innerWidth <= 768
          ? '105px 16px 40px 16px'
          : '100px 16px 32px 16px',
        textAlign: 'center',
        color: 'white'
      }}>
        <div style={{
          ...
          <h1 style={{
            ...
            fontWeight: 800,
            lineHeight: typeof window !== 'undefined' && window.innerWidth <= 768 ? '34px' : '54px',
            margin: '0 0 16px 0',
            color: 'white',
          ...
          <p style={{
            fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", "Roboto", "Helvetica Neue", Arial, sans-serif',
            fontSize: typeof window !== 'undefined' && window.innerWidth <= 768 ? '15px' : '18px',
            lineHeight: typeof window !== 'undefined' && window.innerWidth <= 768 ? '23px' : '28px',
          ...
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '8px',
              padding: typeof window !== 'undefined' && window.innerWidth <= 768 ? '8px 14px' : '8px 16px',
              color: 'white',
            ...
            <div>
              <a href="/kontakt" style={{
                ...
                color: '#374151',
                padding: typeof window !== 'undefined' && window.innerWidth <= 768 ? '14px 28px' : '16px 32px',
                borderRadius: '9999px',
                fontSize: '14px',
                fontWeight: 600,
                textDecoration: 'none',
                ...
                minHeight: typeof window !== 'undefined' && window.innerWidth <= 768 ? '48px' : 'auto',
                cursor: 'pointer',
