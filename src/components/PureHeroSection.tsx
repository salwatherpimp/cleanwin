  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: `
          <section style="position:relative;width:100vw;height:64vh;min-height:476px;max-height:64vh;overflow:hidden;padding-top:clamp(80px, 12vw, 80px);" class="hero-section">
            ...
            <div style="position:relative;z-index:10;height:100%;display:flex;align-items:center;justify-content:center;padding:20px 16px 32px 16px;text-align:center;color:white;" class="hero-content">
