export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Dark Overlay - Exact Same as Original */}
      <div
        style={{
          position: "absolute",
          inset: "0",
      ...
      {/* Content Container - Exact Same Layout */}
      <div
        style={{
          position: "relative",
          zIndex: 10,
      ...
      >
        ...
        >
          ...
          {/* Reviews Badge - Exact Same Styling */}
          <div
            style={{
              display: "inline-flex",
              alignItems: "center",
          ...
          >
            ...
            >
              {/* Stars - Exact Same Implementation */}
              <div style={{ display: "flex" }}>
                ...
                {/* Half star - Exact Same Implementation */}
